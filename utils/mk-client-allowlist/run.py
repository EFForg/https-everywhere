...
# Make a list of the current top 1,000 certs to allowlist from the
# Decentralized SSL Observatory's client submissions, to live in
# https-everywhere/src/chrome/content/code/X509ChainAllowlist.js
...
// This file is automatically generated by utils/mk_client_allowlist.py

const X509ChainAllowlist = {"""
