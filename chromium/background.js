...
let getStoredUserRules = function() {
  let oldUserRuleString = ls.getItem(USER_RULE_KEY);
  let oldUserRules = [];
 ...
 * */
let addNewRule = function(params, cb) {
